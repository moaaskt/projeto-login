...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div>
        <a href="<?= base_url('dashboard/clientes') ?>" class="btn btn-secondary">Voltar</a>
...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="card">
            <div class="card-header">
                <h6><i class="fas fa-qrcode me-2"></i>Cartão de Visita Digital (vCard)</h6>
            </div>
            <div class="card-body text-center">
                <p class="text-muted"><small>Escaneie o código com a câmera do seu celular para salvar este contato.</small></p>
                <img src="<?= $qrCodeDataUri ?>" alt="QR Code vCard" class="img-fluid">
            </div>
        </div>
    </div>
</div>
