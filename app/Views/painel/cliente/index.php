                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><a href="#" class="btn btn-info btn-sm"><i class="fas fa-eye"></i></a></td>
                        </tr>
                        <tr>
                            <td>INV-00124</td> <td>Cliente B</td> <td>2025-08-10</td> <td>R$ 850,50</td> <td><span class="badge bg-warning text-dark">Pendente</span></td>
                            <td><a href="#" class="btn btn-info btn-sm"><i class="fas fa-eye"></i></a></td>
                        </tr>
                    </tbody>
                </table>
