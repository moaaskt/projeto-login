...
<head>
    ...
    <style>
        ...
        .register-container { background: #ffffff; border-radius: 15px; box-shadow: 0 10px 30px rgba(0, 0, 0, 0.1); padding: 2.5rem; width: 100%; max-width: 480px; }
        .register-header { text-align: center; margin-bottom: 2rem; }
        .register-header img { width: 80px; height: auto; margin-bottom: 1rem; }
        .register-header h1 { font-weight: 700; font-size: 1.75rem; }
        .form-control { height: 50px; border: 1px solid #e2e8f0; border-radius: 8px; background-color: #f8fafc; }
        .form-control:focus { border-color: var(--primary-color); box-shadow: 0 0 0 0.2rem rgba(99, 102, 241, 0.2); }
